  ...
  return (
    <main className="audit-page">
      <header className="audit-header">
        <div><span>SEGURANÇA E CONTROLE</span><h1>Auditoria de alterações</h1><p>Histórico de inclusões, alterações, exclusões e operações sensíveis realizadas no SIEDU-PINDOBAÇU.</p></div>
