...
export const api = {
  ...
  getPersonnelDocumentReferences(token) { return request('/personnel-documents/references', {}, token); },
  listPersonnelDocuments(usuarioId, token) { return getWithFilters('/personnel-documents', { usuarioId }, token); },
  createPersonnelDocument(data, token) { return post('/personnel-documents', data, token); },
  createPersonnelDocumentVersion(id, data, token) { return post(`/personnel-documents/${id}/versions`, data, token); },
  downloadPersonnelDocumentVersion(documentId, versionId, filename, token) { return download(`/personnel-documents/${documentId}/versions/${versionId}/download`, filename, token); },
