...
function SystemBrand() {
  return <div className="siedu-global-brand" aria-label="SIEDU — Sistema Integrado de Educação"><img src="/images/siedu-logo-transparent.svg" alt="SIEDU — Sistema Integrado de Educação" /></div>;
}
...
export default function App() {
  ...
  return (
    <><SystemBrand/><MunicipalBrand user={session?.user} /><Routes>
      ...
      <Route
        ...
        element={<Protected token={session?.token}>{isProfessor(session?.user) ? <ProfessorMateriais token={session?.token} /> : <Navigate to={destinationFor(session?.user)} replace />}</Protected>}
      />
      ...
      <Route
        ...
        element={<Protected token={session?.token}>{isProfessor(session?.user) ? <ProfessorAtividades token={session?.token} user={session?.user} /> : <Navigate to={destinationFor(session?.user)} replace />}</Protected>}
      />
      <Route
        path="/professor/calendario"
        element={<Protected token={session?.token}>{isProfessor(session?.user) ? <ProfessorCalendario token={session?.token} /> : <Navigate to={destinationFor(session?.user)} replace />}</Protected>}
      />

      <Route
        path="/professor/planos"
        element={<Protected token={session?.token}>{isProfessor(session?.user) ? <ProfessorPlanos token={session?.token} user={session?.user} /> : <Navigate to={destinationFor(session?.user)} replace />}</Protected>}
      />

      <Route
        path="/professor/planejamento"
        element={<Protected token={session?.token}>{isProfessor(session?.user) ? <ProfessorPlanejamento token={session?.token} user={session?.user} /> : <Navigate to={destinationFor(session?.user)} replace />}</Protected>}
      />

      <Route
        path="/professor/boletim/:turmaId"
        element={<Protected token={session?.token}>{isProfessor(session?.user) ? <ProfessorBoletim token={session?.token} user={session?.user} /> : <Navigate to={destinationFor(session?.user)} replace />}</Protected>}
      />

      <Route
        path="/professor/notas"
        element={<Protected token={session?.token}>{isProfessor(session?.user) ? <ProfessorNotas token={session?.token} user={session?.user} /> : <Navigate to={destinationFor(session?.user)} replace />}</Protected>}
      />
      ...
      <Route
        ...
        element={
          <Protected token={session?.token}>
            {isProfessor(session?.user) ? <ProfessorDashboard user={session?.user} onLogout={logout} token={session?.token} /> : <Navigate to={destinationFor(session?.user)} replace />}
          </Protected>
        }
      />
      ...
      <Route
        ...
        element={<Protected token={session?.token}><Allowed allowed={isEducationAdministration(session?.user)} user={session?.user}><AdministracaoProtocolo token={session?.token} user={session?.user} onLogout={logout}/></Allowed></Protected>}
      />
      <Route
        path="/administracao/solicitacoes"
        element={<Protected token={session?.token}><Allowed allowed={isEducationAdministration(session?.user)} user={session?.user}><AdministracaoSolicitacoes token={session?.token} user={session?.user} onLogout={logout}/></Allowed></Protected>}
      />

      <Route
        path="/administracao/transporte"
        element={<Protected token={session?.token}><Allowed allowed={isEducationAdministration(session?.user)} user={session?.user}><AdministracaoTransporte token={session?.token} user={session?.user} onLogout={logout}/></Allowed></Protected>}
      />
