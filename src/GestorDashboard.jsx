  ...
  return (
    <aside className="dashboard-sidebar">
      <div className="sidebar-brand">
        ...
        <div><strong>SIEPIN</strong><span>Sistema Integrado de Educação</span></div>
      </div>
    ...
    <div className="gestor-dashboard" id="dashboard">
      ...
      <div className="dashboard-main">
        ...
        <main className="dashboard-content" id="indicadores">
          ...
          <footer className="dashboard-footer">© 2026 SIEPIN — Sistema Integrado de Educação de Pindobaçu. Todos os direitos reservados.<span>Versão 0.0.1 · Dados atualizados automaticamente</span></footer>
        </main>
      </div>
    </div>
  );
