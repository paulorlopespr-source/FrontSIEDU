...
export default function CoordenadorDashboard({ user, token, onLogout }) {
  ...
  return <div className="siedu-legacy-portal siedu-profile-page coordinator-portal" style={{ minHeight: '100vh', background: '#f4f7fc', color: '#09245a', fontFamily: 'Arial, sans-serif' }}>
    <header className="siedu-legacy-topbar siedu-profile-header" style={{ height: 78, background: '#fff', display: 'flex', alignItems: 'center', padding: '0 4%', gap: 24, boxShadow: '0 2px 12px #dbe4f255', position: 'sticky', top: 0, zIndex: 2 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}><img className="portal-header-logo" src="/images/siedu-logo-transparent.svg" alt="SIEDU" /><div><b style={{ fontSize: 21 }}>Portal do Coordenador</b><small style={{ display: 'block', color: '#607399' }}>Coordenação Pedagógica Municipal</small></div></div>
    ...
    <main className="siedu-legacy-layout" style={{ display: 'grid', gridTemplateColumns: '240px 1fr', minHeight: 'calc(100vh - 78px)' }}>
      <aside className="siedu-legacy-sidebar" style={{ background: 'linear-gradient(#063675,#04285b)', color: '#fff', padding: '28px 18px' }}>
        ...
        <p style={{ marginTop: 38, borderTop: '1px solid #ffffff33', paddingTop: 18, fontSize: 12 }}>Secretaria Municipal de Educação<br />SIEDU</p>
      </aside>
